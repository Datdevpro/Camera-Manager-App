...
home = ImageTk.PhotoImage(Image.open('df1.png').resize((40,40),Image.Resampling.LANCZOS))
settings = ImageTk.PhotoImage(Image.open('add.png').resize((40,40),Image.Resampling.LANCZOS))
ring = ImageTk.PhotoImage(Image.open('df2.png').resize((40,40),Image.Resampling.LANCZOS))
